...
public class KeyCloakAuthenticationMechanism implements HttpAuthenticationMechanism {
	...
	protected AuthenticationStatus performKeyCloakLogin(HttpServletRequest req, HttpServletResponse res,
		...
		if (this.deployment == null || !this.deployment.isConfigured()) {
			logger.error(
			...
			FilterRequestAuthenticator authenticator = new FilterRequestAuthenticator(deployment, tokenStore, facade,
					req, 8443);
